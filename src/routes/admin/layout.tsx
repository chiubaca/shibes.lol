    ...
    <div className="container mx-auto p-6">
      ...
      <div className="tabs tabs-boxed mb-6">
        <Link to="/admin/stats" className="tab">
          {({ isActive }) => (
            <span className={isActive ? "tab-active" : ""}>Overview</span>
          )}
        </Link>
        <Link to="/admin/shibas" className="tab">
          {({ isActive }) => (
            <span className={isActive ? "tab-active" : ""}>Shiba Management</span>
          )}
        </Link>
        <Link to="/admin/users" className="tab">
          {({ isActive }) => (
            <span className={isActive ? "tab-active" : ""}>User Management</span>
          )}
        </Link>
      </div>
